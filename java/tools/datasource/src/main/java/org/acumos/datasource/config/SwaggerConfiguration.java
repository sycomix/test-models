...
import org.acumos.datasource.DataSourceApplication;
...
public class SwaggerConfiguration {
	...
	private ApiInfo apiInfo() {
		final String version = DataSourceApplication.class.getPackage().getImplementationVersion();
		return new ApiInfo("Datasource REST API", // title
				...
				new Contact("Acumos Team", // name
						"http://acumos.org", // URL
						"acumosaidevdiscuss@lists.acumos.org"), // email
				"Apache 2.0", // License
